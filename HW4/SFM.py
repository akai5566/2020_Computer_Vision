...
img_list = [('Statue1.bmp','Statue2.bmp',0)]
...
if __name__ == '__main__':
    ...
    for img in img_list:
        img1 = cv2.imread('./data/{}'.format(img[0]), 0)
        img2 = cv2.imread('./data/{}'.format(img[1]), 0)
        ...
        #match = find_match(des1, des2) # feature matching
        ...
        plt.savefig(f"./result/epiline/good.png")
        plt.show()
